...
const Checkout = () => {
  ...
  <div
    key={item.id}
    className="grid grid-cols-[70px_1fr_auto] gap-4 pb-4 border-b border-border last:border-0 items-center"
  >
    {/* Image */}
    {item.image && (
      <img
    ...
    {/* Buttons (NEVER MOVE NOW) */}
    <div className="flex items-center gap-2 justify-end min-w-[130px]">
      <Button
        variant="outline"
        size="icon"
